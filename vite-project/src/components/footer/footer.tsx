  ...
  return (
    <footer className="relative bg-gradient-to-r from-secondaryBlue to-secondaryGreen w-[100vw] h-[60vh] flex flex-col justify-center ">
      <div className='flex flex-row w-full h-full justify-around items-start text-white'>
        <div className='flex flex-col items-start relative top-6 right-60'>
        ...
        <div className='flex flex-col items-start relative top-6 right-[40rem]'>
      ...
      <img src={Logo} alt="Logo" className='relative w-[5%] h-[90px] bottom-14 left-[40rem] ' />
    </footer>
  );
};
